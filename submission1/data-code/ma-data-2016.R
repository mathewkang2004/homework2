...
# Landscape data ----------------------------------------------------------
# Import data
ma.path.a <- paste0("data/input/2016LandscapeSource file MA_AtoM 04222016.csv")
...
ma.path.b <- paste0("data/input/2016LandscapeSource file MA_NtoW 04222016.csv")
...
mapd.path.a <- paste0("data/input/Medicare Part D 2016 Plan Report 04222016.xls")
...
mapd.path.b <- paste0("data/input/Medicare Part D 2016 Plan Report 04222016.xls")
...
# Risk rebate data --------------------------------------------------------
# Import data
ma.path.a <- "data/input/2016PartCPlanLevel.xlsx"
...
ma.path.b <- "data/input/2016PartDPlans.xlsx"
...
# FFS data ----------------------------------------------------------------
# Import data
ffs.data <- read_xlsx("data/input/FFS16.xlsx",
                      skip=2,
