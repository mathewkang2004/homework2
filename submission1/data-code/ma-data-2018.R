...
# Landscape data ----------------------------------------------------------
# Import data
ma.path.a <- paste0("data/input/2018LandscapeSource file MA_AtoM 10142017.csv")
...
ma.path.b <- paste0("data/input/2018LandscapeSource file MA_NtoW 10142017.csv")
...
mapd.path.a <- paste0("data/input/Medicare Part D 2018 Plan Report 09142017.xls")
...
mapd.path.b <- paste0("data/input/Medicare Part D 2018 Plan Report 09142017.xls")
...
# Risk rebate data --------------------------------------------------------
# Import data
ma.path.a <- "data/input/2018PartCPlanLevel.xlsx"
...
ma.path.b <- "data/input/2018PartDPlans.xlsx"
...
# FFS data ----------------------------------------------------------------
# Import data
ffs.data <- read_xlsx("data/input/FFS18.xlsx",
                      skip=2,
