...
# Landscape data ----------------------------------------------------------
# Import data
ma.path.a <- paste0("data/input/2015LandscapeSource file MA_AtoM 11042014.csv")
...
ma.path.b <- paste0("data/input/2015LandscapeSource file MA_NtoW 11042014.csv")
...
mapd.path.a <- paste0("data/input/Medicare Part D 2015 Plan Report 03182015.xls")
...
mapd.path.b <- paste0("data/input/Medicare Part D 2015 Plan Report 03182015.xls")
...
# Risk rebate data --------------------------------------------------------
# Import data
ma.path.a <- "data/input/2015PartCPlanLevel.xlsx"
...
ma.path.b <- "data/input/2015PartDPlans.xlsx"
...
# FFS data ----------------------------------------------------------------
# Import data
ffs.data <- read_xlsx("data/input/FFS15.xlsx",
                     skip=2,
