...
# Landscape data ----------------------------------------------------------
# Import data
ma.path.a <- paste0("data/input/2014LandscapeSource file MA_AtoM 05292014.csv")
...
ma.path.b <- paste0("data/input/2014LandscapeSource file MA_NtoW 05292014.csv")
...
mapd.path.a <- paste0("data/input/Medicare Part D 2014 Plan Report 05292014.xls")
...
mapd.path.b <- paste0("data/input/Medicare Part D 2014 Plan Report 05292014.xls")
...
# Risk rebate data --------------------------------------------------------
# Import data
ma.path.a <- "data/input/2014PartCPlan Level.xlsx"
...
ma.path.b <- "data/input/2014PartDPlans.xlsx"
...
# FFS data ----------------------------------------------------------------
# Import data
ffs.data <- read_csv("data/input/aged14.csv",
                     skip=2,
