...
load_month <- function(m, y) {
  c_path <- paste0("data/input/CPSC_Contract_Info_", y, "_", m, ".csv")
  e_path <- paste0("data/input/CPSC_Enrollment_Info_", y, "_", m, ".csv")
...
load_month_sa <- function(m, y) {
  path <- paste0("data/input/MA_Cnty_SA_",y, "_", m, ".csv")
...
load_month_pen <- function(m, y) {
  path <- paste0("data/input/State_County_Penetration_MA_",y, "_", m, ".csv")
