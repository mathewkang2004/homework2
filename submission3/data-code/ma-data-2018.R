...
# Landscape data ----------------------------------------------------------
# Import data
ma.path.a <- paste0("data/input/ma/landscape/Extracted Data/2018LandscapeSource file MA_AtoM 10142017.csv")
...
ma.path.b <- paste0("data/input/ma/landscape/Extracted Data/2018LandscapeSource file MA_NtoW 10142017.csv")
...
mapd.path.a <- paste0("data/input/ma/landscape/Extracted Data/PartCD/2018/Medicare Part D 2018 Plan Report 09142017.xls")
...
mapd.path.b <- paste0("data/input/ma/landscape/Extracted Data/PartCD/2018/Medicare Part D 2018 Plan Report 09142017.xls")
...
# FFS data ----------------------------------------------------------------
# Import data
ffs.data <- read_xlsx("data/input/ffs-costs/Extracted Data/FFS2018/FFS18.xlsx",
                      skip=2,
