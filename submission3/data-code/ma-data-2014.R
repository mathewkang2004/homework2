...
# Risk rebate data --------------------------------------------------------
# Import data
ma.path.a <- "data/input/ma/cms-payment/2014/2014PartCPlan Level.xlsx"
...
ma.path.b <- "data/input/ma/cms-payment/2014/2014PartDPlans.xlsx"
...
# FFS data ----------------------------------------------------------------
# Import data
ffs.data <- read_csv("data/input/ffs-costs/Extracted Data/Aged Only/aged14.csv",
                     skip=2,
